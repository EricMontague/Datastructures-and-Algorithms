...
directed graph representeed as an adjacency list. I assume that all 
of the vertices (inputs) are positive integers and edges can be 
either positive or negative integers.
"""

import unittest
from graph_theory.directed_graphs.weighted_digraph_adjacency_list import WeightedDiGraph
...
class WeightedDiGraphTestCase(unittest.TestCase):
    ...
    def test_set_edge_when_both_vertices_dont_exist(self):
        ...
        # add edge from 10 -> 11
        self.empty_graph.set_edge(10, 11, 2)
        ...
        self.assertEqual(self.empty_graph.get_neighbors(10), [(11, 2)])
    ...
    def test_set_edge_when_one_vertex_exists(self):
        ...
        # set edge
        self.non_empty_graph.set_edge(4, 20, -15)
        ...
        self.assertTrue((20, -15) in self.non_empty_graph.get_neighbors(4))
