"""This module contains tests for my KMP pattern matching
algorithm.
"""

import unittest
from strings.kmp_algorithm import kmp_algorithm
...
class KMPTestCase(unittest.TestCase):
    ...
    def test_pattern_exists_in_string_and_returns_first_occurrence(self):
        ...
        string, that the KMP algorithm returns the index of the first occurrence
        of the pattern.
        """
        self.assertTrue(self.pattern2 in self.string2)
        self.assertTrue(self.string2.count(self.pattern2) > 1)
        self.assertEqual(3, kmp_algorithm(self.pattern2, self.string2))
